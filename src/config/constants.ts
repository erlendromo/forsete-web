...
export enum ApiEndpoints {
  ...
  REGION_MODELS_ENDPOINT = ApiEndpoints.VERSION_ATR +
    "models/region-segmentation-models/",
  LINE_MODELS_ENDPOINT = ApiEndpoints.VERSION_ATR +
    "models/line-segmentation-models/",
  TEXT_MODELS_ENDPOINT = ApiEndpoints.VERSION_ATR +
    "models/text-recognition-models/",
